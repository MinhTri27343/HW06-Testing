# Checklist đóng gói HW06

Tên ZIP dự kiến: `23127502_HW06_AI_API_090.zip`

## Đã tạo

- [x] Báo cáo chính Markdown.
- [x] API specification và đề bài.
- [x] 120 test cases; 105 AI + 15 human.
- [x] Audit VALID/INVALID/INCOMPLETE và corrections.
- [x] Postman collection/environment/data files.
...
## Sinh viên phải hoàn tất

- [ ] Import collection vào Postman workspace và chụp console có `X-Student-Id: 23127502`.
- [ ] Chụp evidence thật cho từng issue rồi xác nhận nội dung.
- [ ] Cho phép push `main`, chờ Actions run passing và lưu link/ảnh.
